...
from vs.socialfooter.browser.interfaces import ISocialFooterPanelSchema

from vs.socialfooter import _

INTERFACE = 'vs.socialfooter.browser.interfaces.ISocialFooterPanelSchema'
...
$('.sequencewidget .textType').hide().each(function(){
    ...
    $me.after('<a style="background-color: #ccc; ' +
                        ...
                        'float: left; " ' +
                  'href="' + iUrl + '">' +
                  '<img src="++resource++vs.socialfooter.mono/' +
                             iType + '/' +
                             iColor + '/' +
                             iProvider + '.png"' +
                        'alt="' + iTitle + '" ' +
